package cum.xiaomao.zerohack.mixins.core.tileentity;

import cum.xiaomao.zerohack.util.ClassIDRegistry;
import cum.xiaomao.zerohack.util.interfaces.ITypeID;
