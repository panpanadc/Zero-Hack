...
import cum.xiaomao.zerohack.gui.rgui.windows.ColorPicker
...
import cum.xiaomao.zerohack.util.accessor.listShaders
...
import cum.xiaomao.zerohack.util.graphics.shaders.ParticleShader
...
abstract class AbstractZeroGui<S : SettingWindow<*>, E : Any> : GuiScreen(), IListenerOwner by ListenerOwner() {
