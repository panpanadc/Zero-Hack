...
import cum.xiaomao.zerohack.gui.rgui.component.Button
import cum.xiaomao.zerohack.gui.rgui.component.SettingSlider
import cum.xiaomao.zerohack.gui.rgui.component.Slider
...
object ColorPicker : TitledWindow("Color Picker", 0.0f, 0.0f, 200.0f, 200.0f, SettingGroup.NONE) {
    ...
    private var hoveredChild: Slider? = null
        set(value) {
            ...
            field?.onLeave(AbstractZeroGui.getRealMousePos())
            value?.onHover(AbstractZeroGui.getRealMousePos())
            field = value
        }
