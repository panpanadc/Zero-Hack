...
import cum.xiaomao.zerohack.gui.rgui.InteractiveComponent
...
open class ListWindow(
    ...
    var hoveredChild: Component? = null
        private set(value) {
            ...
            (field as? InteractiveComponent)?.onLeave(AbstractZeroGui.getRealMousePos())
            (value as? InteractiveComponent)?.onHover(AbstractZeroGui.getRealMousePos())
            field = value
        }
