package cum.xiaomao.zerohack.gui.mc

import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import cum.xiaomao.zerohack.module.modules.combat.AutoLog
import cum.xiaomao.zerohack.util.threads.mainScope
import net.minecraft.client.gui.GuiButton
import net.minecraft.client.gui.GuiScreen
import java.time.LocalTime

class ZeroGuiDisconnected(private val reason: Array<String>, private val screen: GuiScreen, private val disable: Boolean, private val logoutTime: LocalTime) : GuiScreen() {
