...
object GlyphCache {
    private val directory = "${ZeroHackMod.DIRECTORY}/glyphs"
    ...
    fun put(font: Font, chunk: Int, image: BufferedImage, charInfoArray: Array<CharInfo>) {
        ...
        runCatching {
            ...
            ZeroHackMod.logger.info("Failed saving glyph cache", e)
            runCatching {
                imageFile.delete()
                infoFile.delete()
            }.onFailure {
                ZeroHackMod.logger.error("Error saving glyph cache", it)
            }
        }
    }
    ...
    fun get(font: Font, chunk: Int): Pair<BufferedImage, Array<CharInfo>>? {
        return runCatching {
            ...
            ZeroHackMod.logger.error("Error reading glyph cache", it)
        }.getOrNull()
    }
