package cum.xiaomao.zerohack.util.graphics.font

import it.unimi.dsi.fastutil.bytes.ByteArrayList
import it.unimi.dsi.fastutil.floats.FloatArrayList
import it.unimi.dsi.fastutil.shorts.ShortArrayList
import cum.xiaomao.zerohack.util.graphics.GLDataType
import cum.xiaomao.zerohack.util.graphics.buildAttribute
import cum.xiaomao.zerohack.util.graphics.color.ColorRGB
import cum.xiaomao.zerohack.util.graphics.font.glyph.CharInfo
import cum.xiaomao.zerohack.util.graphics.font.glyph.GlyphChunk
import cum.xiaomao.zerohack.util.graphics.font.renderer.AbstractFontRenderContext
import cum.xiaomao.zerohack.util.graphics.font.renderer.AbstractFontRenderer
import cum.xiaomao.zerohack.util.graphics.shaders.DrawShader
import cum.xiaomao.zerohack.util.graphics.use
import cum.xiaomao.zerohack.util.skip
