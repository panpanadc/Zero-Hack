package cum.xiaomao.zerohack.translation

import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.Job
import kotlinx.coroutines.launch
import cum.xiaomao.zerohack.ZeroHackMod
import cum.xiaomao.zerohack.module.modules.client.Language
...
object TranslationManager {
    ...
    fun checkUpdate() {
        defaultScope.launch(Dispatchers.IO) {
            try {
                ...
                ZeroHackMod.logger.warn("Failed to check for translation updates", e)
            }
        }
    }
    ...
    fun reload() {
        ...
        try {
            ...
            translationMap = map
            ZeroHackMod.logger.info("Loaded language $language from $source")
            TranslationKey.updateAll()
        } catch (e: IllegalArgumentException) {
            ZeroHackMod.logger.warn(e.message)
        } catch (e: Exception) {
            ZeroHackMod.logger.warn("Failed to load language $language", e)
        }
    }
