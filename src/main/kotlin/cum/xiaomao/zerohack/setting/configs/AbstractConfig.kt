...
import cum.xiaomao.zerohack.setting.groups.SettingGroup
import cum.xiaomao.zerohack.setting.groups.SettingMultiGroup
...
abstract class AbstractConfig<T : Any>(
    ...
    override fun load() {
        ...
        try {
            ...
            ZeroHackMod.logger.warn("Failed to load latest, loading backup.")
