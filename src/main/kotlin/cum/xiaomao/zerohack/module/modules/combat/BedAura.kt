...
import cum.xiaomao.zerohack.util.EntityUtils.spoofUnSneak
...
import cum.xiaomao.zerohack.util.graphics.mask.EnumFacingMask
...
import cum.xiaomao.zerohack.util.pause.OffhandPause
...
internal object BedAura : Module(
    ...
    private inline fun SafeClientEvent.breakBed(placeInfo: PlaceInfo) {
        ...
        player.spoofUnSneak {
            connection.sendPacket(CPacketPlayerTryUseItemOnBlock(placeInfo.bedPosFoot, side, cum.xiaomao.zerohack.module.modules.combat.BedAura.handMode, hitVecOffset.x, hitVecOffset.y, hitVecOffset.z))
        }
