...
import cum.xiaomao.zerohack.util.PathFinder
import cum.xiaomao.zerohack.util.combat.HoleInfo
import cum.xiaomao.zerohack.util.extension.floorToInt
...
internal object HolePathFinder : Module(
    ...
    private fun getTargetPos(): BlockPos? {
        return (AutoCrystalPlus.target.takeIf { AutoCrystalPlus.isEnabled } ?: CombatManager.target)?.betterPosition
    }
