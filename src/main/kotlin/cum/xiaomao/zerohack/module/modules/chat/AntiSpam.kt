...
import cum.xiaomao.zerohack.util.text.SpamFilters
...
internal object AntiSpam : Module(
    ...
    private fun sendResult(name: String, message: String) {
        ...
        if (showBlocked == ShowBlocked.LOG_FILE || showBlocked == ShowBlocked.BOTH) ZeroHackMod.logger.info("$chatName $name: $message")
    }
}
