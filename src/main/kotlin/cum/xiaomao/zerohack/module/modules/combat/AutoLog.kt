...
import cum.xiaomao.zerohack.gui.mc.ZeroGuiDisconnected
...
import cum.xiaomao.zerohack.module.modules.combat.AutoLog.Reasons.*
...
internal object AutoLog : Module(
    ...
    private fun SafeClientEvent.log(reason: Reasons, additionalInfo: String = "") {
        ...
        mc.displayGuiScreen(ZeroGuiDisconnected(reasonText, screen, disableMode == DisableMode.ALWAYS || (disableMode == DisableMode.NOT_PLAYER && reason != PLAYER), LocalTime.now()))
    }
