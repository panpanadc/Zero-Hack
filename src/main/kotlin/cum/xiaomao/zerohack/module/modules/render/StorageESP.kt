...
import cum.xiaomao.zerohack.util.and
...
import cum.xiaomao.zerohack.util.graphics.esp.DynamicBoxRenderer
import cum.xiaomao.zerohack.util.graphics.esp.DynamicTracerRenderer
import cum.xiaomao.zerohack.util.graphics.esp.StaticBoxRenderer
import cum.xiaomao.zerohack.util.graphics.esp.StaticTracerRenderer
import cum.xiaomao.zerohack.util.graphics.mask.SideMask
import cum.xiaomao.zerohack.util.math.vector.distanceSqTo
import cum.xiaomao.zerohack.util.or
...
internal object StorageESP : Module(
    ...
    /* Type settings */
    private val piston by setting("Piston", true, page.atValue(Page.TYPE))
    ...
    private val colorPiston by setting("Piston Color", ColorRGB(255, 132, 32), true, page.atValue(Page.COLOR))
    ...
    private fun checkTileEntityType(tileEntity: TileEntity): Boolean {
        return chest && tileEntity is TileEntityChest
            || piston && tileEntity is TileEntityPiston
    ...
    private fun getTileEntityColor(tileEntity: TileEntity): ColorRGB {
        return when (tileEntity) {
            ...
            is TileEntityPiston -> colorPiston
