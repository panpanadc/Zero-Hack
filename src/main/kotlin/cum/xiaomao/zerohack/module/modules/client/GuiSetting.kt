...
internal object GuiSetting : Module(
    ...
    private val windowBlur0 = setting("Window Blur", false)
    ...
    private val primarySetting by setting("Primary Color", ColorRGB(255, 255, 255, 220))
    private val outlineSetting by setting("Outline Color", ColorRGB(240, 250, 255, 48))
    private val backgroundSetting by setting("Background Color", ColorRGB(36, 40, 48, 0))
