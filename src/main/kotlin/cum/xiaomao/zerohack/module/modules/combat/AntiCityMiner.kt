...
internal object AntiCityMiner : Module(
    name = "AntiCity",
    ...
    private enum class SurroundOffset(val offset: BlockPos) {
        ...
        WEST(BlockPos(-1, 0, 0)),//
        NORTH1(BlockPos(0, 1, -1)),
        EAST1(BlockPos(1, 1, 0)),
        SOUTH1(BlockPos(0, 1, 1)),
        WEST1(BlockPos(-1, 1, 0)),//
        NORTH2(BlockPos(0, 2, -1)),
        EAST2(BlockPos(1, 2, 0)),
        SOUTH2(BlockPos(0, 2, 1)),
        WEST2(BlockPos(-1, 2, 0)),//
        NORTH3(BlockPos(0, 3, -1)),
        EAST3(BlockPos(1, 3, 0)),
        SOUTH3(BlockPos(0, 3, 1)),
        WEST3(BlockPos(-1, 3, 0)),//
        WEST4(BlockPos(0, 3, 0)),//
        WEST41(BlockPos(0, 4, 0)),//
        NORTH5(BlockPos(0, 0, -2)),
        EAST5(BlockPos(2, 0, 0)),
        SOUTH5(BlockPos(0, 0, 2)),
        WEST5(BlockPos(-2, 0, 0)),//
        NORTH6(BlockPos(0, 1, -2)),
        EAST6(BlockPos(2, 1, 0)),
        SOUTH6(BlockPos(0, 1, 2)),
        WEST6(BlockPos(-2, 1, 0)),//
        c7(BlockPos(-1, 0, -1)),
        E7(BlockPos(1, 0, 1)),
        S7(BlockPos(1, 0,-1)),
        W7(BlockPos(-1, 0, 1)),//
