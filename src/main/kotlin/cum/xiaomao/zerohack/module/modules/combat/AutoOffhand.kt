...
import cum.xiaomao.zerohack.util.accessor.potion
import cum.xiaomao.zerohack.util.combat.CombatUtils.calcDamageFromMob
import cum.xiaomao.zerohack.util.combat.CombatUtils.calcDamageFromPlayer
...
import cum.xiaomao.zerohack.util.inventory.operation.moveTo
import cum.xiaomao.zerohack.util.inventory.operation.swapToItemOrMove
import cum.xiaomao.zerohack.util.inventory.slot.craftingSlots
import cum.xiaomao.zerohack.util.inventory.slot.hotbarSlots
import cum.xiaomao.zerohack.util.inventory.slot.inventorySlots
import cum.xiaomao.zerohack.util.inventory.slot.offhandSlot
import cum.xiaomao.zerohack.util.items.isWeapon
...
internal object AutoOffhand : Module(
    ...
    private fun checkCrystal(): Boolean {
        return offhandCrystal && checkCACrystal
            ...
            || AutoCrystalPlus.isActive() && CombatManager.isOnTopPriority(AutoCrystalPlus))
    }
