        ...
        create("client") {
            ...
            properties(
                mapOf(
                    ...
                    "fml.coreMods.load" to "cum.xiaomao.zerohack.ZeroHackCoreMod",
...
tasks {
    ...
    val releaseJar = register<Jar>("releaseJar") {
        ...
        manifest {
            attributes(
                ...
                "MixinConfigs" to "mixins.zero.core.json, mixins.zero.accessor.json, mixins.zero.patch.json",
                "TweakClass" to "org.spongepowered.asm.launch.MixinTweaker",
                "FMLCorePluginContainsFMLMod" to true,
                "FMLCorePlugin" to "cum.xiaomao.zerohack.ZeroHackCoreMod",
    ...
    register<Task>("shrinkJar") {
        ...
        doLast {
            ...
            val process = Runtime.getRuntime().exec("java -Dfile.encoding=UTF-8 -jar \"JarOptimizer.jar\" -i \"$outputJar\" -o \"${outputJar.parent}/${outputJar.nameWithoutExtension}-Optimized.jar\" -k \"cum.xiaomao\" -k \"baritone\" -k \"org.spongepowered\"")
    ...
    register<Task>("genRuns") {
        ...
        doLast {
            ...
            val vmOptions = listOf(
                ...
                "-Dfml.coreMods.load=cum.xiaomao.zerohack.ZeroHackCoreMod"
            ).joinToString(" ")
